...
const Navlink = styled(NavLink)`
  ...
  background-color: ${(props) =>
    props.$current ? " var(--color-primary-variant-light)" : ""};
  &:hover {
    background-color: var(--color-primary-variant-light);
  }
`;

const NavlinkSmall = styled(Navlink)`
  margin-left: 10px;
`;
      ...
      <NavList>
        <li>
          ...
          <li>
            ...
            <li>
              <NavlinkSmall to="/past-reservations">
                <SpanSmall>Past</SpanSmall>
              </NavlinkSmall>
            </li>
          </NavList>
        </li>
        {navList.map((el, i) => (
          <li key={i}>
            <Navlink to={el.path} $current={pathname === el.path}>
              {el.img}
              <Span>{el.name}</Span>
            </Navlink>
          </li>
